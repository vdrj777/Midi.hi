...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding-top: 70px; /* Espacio para que el contenido no quede debajo del menú fijo */
        ...
        .content {
            ...
            min-height: 1000px; /* Altura suficiente para el scroll */
            text-align: justify;
        }
